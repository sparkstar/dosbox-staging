		...
		switch (flags_type) {
			...
			case t_ADDd:
			        write_uint16(pos, ADD_REG(HOST_a1, HOST_a1,
			                                  HOST_a2)); // add a1,
			                                             // a1, a2
			        write_uint16(pos + 2, B_FWD(10)); // b after_call
			                                          // (pc+10)
			        break;
		        case t_ORb:
			case t_ORw:
			...
			case t_TESTw:
			case t_TESTd:
			        write_uint16(pos, B_FWD(12)); // b after_call
			                                      // (pc+12)
			        break;
			case t_INCb:
			case t_INCw:
			...
			case t_SHLd:
		        ...
		        case t_SHRb:
			        ...
			        write_uint16(pos + 6, B_FWD(6)); // b after_call
			                                         // (pc+6)
			        break;
		        case t_SHRw:
				...
				write_uint16(pos + 8, LSR_IMM(templo1, HOST_a1, 16));	// lsr templo1, a1, #16
				write_uint16(pos + 10, NOP;								// nop
				write_uint16(pos + 12, ORR(HOST_a1, templo1));			// orr a1, templo1
				write_uint16(pos + 14, ROR_REG(HOST_a1, HOST_a2));		// ror a1, a2
				break;
			case t_RORw:
				write_uint16(pos, LSL_IMM(HOST_a1, HOST_a1, 16));		// lsl a1, a1, #16
				...
				write_uint16(pos + 8, B_FWD(4));							// b after_call (pc+4)
				break;
			case t_RORd:
				write_uint16(pos, ROR_REG(HOST_a1, HOST_a2));			// ror a1, a2
				write_uint16(pos + 2, B_FWD(10));						// b after_call (pc+10)
				break;
			case t_ROLb:
				write_uint16(pos, LSL_IMM(HOST_a1, HOST_a1, 24));		// lsl a1, a1, #24
				write_uint16(pos + 2, NEG(HOST_a2, HOST_a2));			// neg a2, a2
				write_uint16(pos + 4, LSR_IMM(templo1, HOST_a1, 8));		// lsr templo1, a1, #8
				write_uint16(pos + 6, ADD_IMM8(HOST_a2, 32));			// add a2, #32
				write_uint16(pos + 8, ORR(HOST_a1, templo1));			// orr a1, templo1
				write_uint16(pos + 10, LSR_IMM(templo1, HOST_a1, 16));	// lsr templo1, a1, #16
				write_uint16(pos + 12, ORR(HOST_a1, templo1));			// orr a1, templo1
				write_uint16(pos + 14, ROR_REG(HOST_a1, HOST_a2));		// ror a1, a2
				break;
			case t_ROLw:
				...
				write_uint16(pos + 8, ORR(HOST_a1, templo1));			// orr a1, templo1
				write_uint16(pos + 10, NOP;								// nop
				write_uint16(pos + 12, ROR_REG(HOST_a1, HOST_a2));		// ror a1, a2
			...
			case t_ROLd:
				...
				write_uint16(pos + 6, B_FWD(6));							// b after_call (pc+6)
				break;
			case t_NEGb:
			case t_NEGw:
			case t_NEGd:
		...
		switch (flags_type) {
			...
			case t_ADDd:
			        write_uint16(pos, ADD_REG(HOST_a1, HOST_a1,
			                                  HOST_a2)); // add a1,
			                                             // a1, a2
			        write_uint16(pos + 2, B_FWD(12)); // b after_call
			                                          // (pc+12)
			        break;
		        case t_ORb:
			case t_ORw:
			...
			case t_TESTw:
			case t_TESTd:
			        write_uint16(pos, B_FWD(14)); // b after_call
			                                      // (pc+14)
			        break;
			case t_INCb:
			case t_INCw:
			...
			case t_SHLd:
		        ...
		        case t_SHRb:
			        ...
			        write_uint16(pos + 2, LSR_IMM(HOST_a1, HOST_a1,
			                                      24)); // lsr a1,
			                                            // a1, #24
			        write_uint16(pos + 4, LSR_REG(HOST_a1, HOST_a2)); // lsr a1, a2
			        write_uint16(pos + 6, B_FWD(8)); // b after_call
			                                         // (pc+8)
			        break;
		        case t_SHRw:
			        write_uint16(pos, LSL_IMM(HOST_a1, HOST_a1, 16)); // lsl a1, a1, #16
				...
				write_uint16(pos + 12, ORR(HOST_a1, templo1));			// orr a1, templo1
				write_uint16(pos + 14, NOP;								// nop
				write_uint16(pos + 16, ROR_REG(HOST_a1, HOST_a2));		// ror a1, a2
				break;
			case t_RORw:
				write_uint16(pos, LSL_IMM(HOST_a1, HOST_a1, 16));		// lsl a1, a1, #16
				write_uint16(pos + 2, LSR_IMM(templo1, HOST_a1, 16));	// lsr templo1, a1, #16
				write_uint16(pos + 4, ORR(HOST_a1, templo1));			// orr a1, templo1
				write_uint16(pos + 6, ROR_REG(HOST_a1, HOST_a2));		// ror a1, a2
				write_uint16(pos + 8, B_FWD(6));							// b after_call (pc+6)
				break;
			case t_RORd:
				write_uint16(pos, ROR_REG(HOST_a1, HOST_a2));			// ror a1, a2
				write_uint16(pos + 2, B_FWD(12));						// b after_call (pc+12)
				break;
			case t_ROLb:
				write_uint16(pos, LSL_IMM(HOST_a1, HOST_a1, 24));		// lsl a1, a1, #24
				write_uint16(pos + 2, NEG(HOST_a2, HOST_a2));			// neg a2, a2
			...
			case t_ROLw:
				...
				write_uint16(pos + 12, ROR_REG(HOST_a1, HOST_a2));		// ror a1, a2
				write_uint16(pos + 14, NOP;								// nop
				write_uint16(pos + 16, NOP;								// nop
				break;
			case t_ROLd:
				write_uint16(pos, NEG(HOST_a2, HOST_a2));				// neg a2, a2
				write_uint16(pos + 2, ADD_IMM8(HOST_a2, 32));			// add a2, #32
				write_uint16(pos + 4, ROR_REG(HOST_a1, HOST_a2));		// ror a1, a2
				write_uint16(pos + 6, B_FWD(8));							// b after_call (pc+8)
				break;
			case t_NEGb:
			case t_NEGw:
			case t_NEGd:
